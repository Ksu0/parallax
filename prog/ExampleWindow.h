...
{
protected:
	std::shared_ptr<SDL_Texture> _sky, _car1, _city, _cloud, _cloud1, _sun, _road, _car, _lamppost, _lamppost1;
	int _width_cloud, _width_sun, _sky_x, _sky_x2, _sun_x, _sun_y, _cloud_x, _cloud_x2, _cloud_x3, _cloud_x4, _cloud_x5, _cloud_x6, _sky_y, _city_y, _cloud_y, _st_slow, _st_cloud, _st_sun, _st_fast, _st_lamppost, _road_x, _road_x2, _road_y, _car_x, _car_y, _lamppost_x, _lamppost_x2, _lamppost_y, _car1_x, _car1_y, _lamppost1_x, _lamppost1_x2, _lamppost1_y;
